...
const SelectLivreurPage = () => {
  ...
  const columns = ["ID", "Nom", "Position", "Type de véhicule", "Distance max", "Note moyenne", "Actions"]
    ...
    <div className="w-full h-full bg-gray-100 p-6 flex flex-col">
      ...
      <div className="flex flex-1 gap-5 rounded-lg md:flex-row-reverse flex-col">
        ...
        <div className="md:w-5/12 w-full bg-white p-4 rounded-lg shadow-md overflow-auto">
          <h2 className="text-lg font-semibold text-emerald-800 mb-4">Livreurs disponibles</h2>
                  ...
                  livreurs.map((livreur) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2 px-3">{`${position.lat.toFixed(4)}, ${position.lng.toFixed(4)}`}</td>
                        <td className="py-2 px-3">{livreur.vehicule?.type || "N/A"}</td>
                        <td className="py-2 px-3">{livreur.distance_max} km</td>
                        <td className="py-2 px-3">{livreur.note_moyenne.toFixed(1)}/5</td>
