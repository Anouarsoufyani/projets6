...
const DetailCommande = () => {
  ...
  const renderActionButtons = () => {
    ...
    if (role === "commercant" && statut === "en_attente") {
      return (
        <div className="flex gap-4">
          <button className="bg-green-600 text-white px-4 py-2 rounded-xl shadow" onClick={() => {}}>
            Valider
          </button>
          <button className="bg-red-600 text-white px-4 py-2 rounded-xl shadow" onClick={() => {}}>
            Refuser
          </button>
        </div>
      )
    ...
    if (role === "commercant" && statut === "en_preparation") {
      return (
        <button className="bg-blue-600 text-white px-4 py-2 rounded-xl shadow" onClick={() => {}}>
    ...
    if (role === "client" && statut === "en_attente") {
      return (
        <button className="bg-yellow-600 text-white px-4 py-2 rounded-xl shadow" onClick={() => {}}>
          Annuler
        </button>
      )
    }
    ...
    if (["prete_a_etre_recuperee", "recuperee_par_livreur", "livree"].includes(statut)) {
      return (
        <button className="bg-indigo-600 text-white px-4 py-2 rounded-xl shadow" onClick={handleRedirect}>
          Voir la livraison
        </button>
      )
    }
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-emerald-50 to-teal-100 p-6 flex justify-center">
