              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-green-700">
                    Félicitations! Votre compte est <span className="font-semibold">vérifié</span>. Vous pouvez
                  ...
                  {UserDocuments.map((doc) => {
                    ...
                    return (
                      <tr key={doc._id} className="hover:bg-gray-50">
                        <td className="py-4 px-4 text-sm font-medium text-gray-900">{doc.nom}</td>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-between pt-4">
              ...
              <button
                type="submit"
                className={`bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-medium transition-colors ${
                  uploadMutation.isPending ? "opacity-70 cursor-not-allowed" : ""
                }`}
