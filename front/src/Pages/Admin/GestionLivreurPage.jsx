...
const GestionLivreurPage = () => {
  ...
  return (
    <main className="w-full min-h-full bg-gradient-to-br from-emerald-50 to-teal-100 p-6">
      <h1 className="text-2xl font-bold text-emerald-700 mb-6">Gestion livreurs</h1>

      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4 bg-gradient-to-r from-emerald-100 to-emerald-200">
          <h2 className="text-lg font-semibold text-emerald-800">Liste des livreurs ({users.data.length})</h2>
        </div>
