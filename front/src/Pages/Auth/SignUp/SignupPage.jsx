...
const SignupPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    e.preventDefault()
    if (!formData.email || !formData.nom || !formData.password || !formData.numero || !formData.role) {
  ...
  return (
    <main className="flex justify-center items-center w-full h-full bg-gray-100">
      <div className="flex flex-col gap-6 justify-center items-center w-1/2 bg-white p-8 rounded-xl shadow-2xl">
        <h1 className="text-3xl font-bold text-emerald-600 mb-4">Inscription</h1>
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
          ...
          >
            {isPending ? <span className="loading loading-spinner loading-md"></span> : "S'inscrire"}
          </button>
        </form>
